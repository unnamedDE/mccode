...
module.exports = options => {
  ...
  const logParser = regexA("log\\((.+?)\\)").map(e => `tellraw @a[gamemode=!survival, gamemode=!adventure] [{"text":"[Console] ","color":"dark_purple","hoverEvent":{"action":"show_text","value":[{"text":"Logged from the console"}]}},{"text":"${replaceVars(e[1])}","color":"reset"}]`)
